<template>
    <section>
        ...
        <b-table
            ...
            <b-table-column field="name" label="Meno" :searchable="nameSearchable" sortable v-slot="props"  >
                {{ props.row.name}}
            </b-table-column>
            ...
            <b-table-column field="id_role" label="Práva" :searchable="nameSearchable" sortable v-slot="props" >
