...
* Date: 26. 10. 2020
*
* Description:  This component takes in data from EventListComponent and renders them in a
*               detailed format.
*
*/
            ...
            <div class="columns">
                ...
                <div class="column is-3-desktop section1">
                    ...
                    <div class="number-of-tickets">
                        ...
                        <strong style="padding-left: 5px;">POCET MIEST:</strong> <i>5/100</i>
                    </div>

                    <!-- Sign up button -->
                    <div>
                        <b-button type="is-info" style="margin-top: 10px; margin-bottom: 10px;">Prihlasit sa</b-button>
                    </div>
                </div>
                ...
                <div class="column is-2-desktop section3">
                    ...
                    <div class="event-image-gallery">
                        <img @click="isImageModalActive = true" :src="imageGalleryLink" class="imageLink">
                        <img @click="isImageModalActive = true" :src="imageGalleryLink" class="imageLink">
                        <img @click="isImageModalActive = true" :src="imageGalleryLink" class="imageLink">
                        <img @click="isImageModalActive = true" :src="imageGalleryLink" class="imageLink">
                        <img @click="isImageModalActive = true" :src="imageGalleryLink" class="imageLink">
                ...
                <div class="column is-3-desktop section4">
                    <div class="map-container">
                        <HereMap :center="center" style="width: 100%; height: 200px; overflow: hidden; margin: 0px;" />
                    </div>
                    ...
                    <div class="other-details">
                        ...
                        <div class="by">
                            Fakulta prirodnych vied<br>
                            <span style="font-weight: normal;"><i>Katedra informatiky</i></span>
                        </div>
                        ...
                        <b-dropdown aria-role="list">
                            <button class="button is-info" slot="trigger" slot-scope="{ active }">
                                <span>Pridat do kalendara</span>
                                <b-icon :icon="active ? 'menu-up' : 'menu-down'"></b-icon>
                            </button>

                            <b-dropdown-item aria-role="listitem" style="overflow-y: auto;">Action</b-dropdown-item>
                        </b-dropdown>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                imageGalleryLink: 'https://journavel.com/wp-content/uploads/2014/10/img-placeholder-dark.jpg',
                eventDetailsTest: 'Tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam\n' +
