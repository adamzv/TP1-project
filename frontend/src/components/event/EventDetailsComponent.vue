...
<template>
    <div style="max-width: 1500px; margin: 0 auto;">
        ...
        <article class="_card message is-medium">
            <!-- Card header -->
            <div class="message-header" v-bind:class="{
            ...
            <div class="columns">
                <!-- Section 1 -->
                <div class="column is-3-desktop section1" v-bind:class="{
                    ...
                    <!-- Available tickets -->
                    <div class="number-of-tickets" v-bind:class="{
                        eventBackColorFPV:  eventIdFaculty == 1,
                        eventBackColorFF:   eventIdFaculty == 4,
                        eventBackColorFSS:  eventIdFaculty == 3,
                        eventBackColorFP:   eventIdFaculty == 5,
                ...
                <div class="column is-4-desktop section2">
                    ...
                    <!-- Category info -->
                    <div class="alignRight categoryInfo" v-bind:class="{
                        eventBackColorFPV:  eventIdFaculty == 1,
                        eventBackColorFF:   eventIdFaculty == 4,
                        eventBackColorFSS:  eventIdFaculty == 3,
                        eventBackColorFP:   eventIdFaculty == 5,
                ...
                <!-- Section 4 -->
                <div class="column is-3-desktop section4" v-bind:class="{
                    eventDetailsHeaderColorFPV:  eventIdFaculty == 1,
                    eventDetailsHeaderColorFF:   eventIdFaculty == 4,
                    eventDetailsHeaderColorFSS:  eventIdFaculty == 3,
                    eventDetailsHeaderColorFP:   eventIdFaculty == 5,
                    ...
                    <div class="map-container">
                        <h1 style="font-weight: bold; color: white; margin-left: 150px; margin-top: 90px;">Map</h1>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getMonth() {
                let month_id = parseInt(this.eventBeginning.substr(5, this.eventBeginning.indexOf("-") - 2));
